				...
				<div class="panel panel-default">
					...
					<div class="panel-body" style="margin-bottom:0;padding-top: 0px">
						...
						<div class="row" style="margin-top: 10px">
							<div class="col-xs-7">
								<?php if (isset($shipping) && $shipping != null) {

								?>
									Shipping : <br>
									<?php if ($shipping['path_img'] != null && $shipping['path_img'] != "") { ?> <img class="rounded" scr="<?= base_url() . $shipping['path_img']; ?>" width="3"> <?php } ?> <b><?= $shipping['parentname'] ?></b> <?= $shipping['name']; ?>
								<?php  } ?>
							</div>
