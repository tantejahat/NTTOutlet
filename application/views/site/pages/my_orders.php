										...
										<div class="col-md-4 col-sm-4 col-xs-12 order_track_item">
											...
											<div class="order_cancle_btn_item">
												<a href="<?php echo site_url('my-orders/' . $value->order_unique_id); ?>">
													<div class="cancle_order_btn"> Detail</div>
												</a>
											</div>
											<!-- <div class="order_cancle_btn_item">
												<a href="<?php echo site_url('my-orders/' . $value->order_unique_id); ?>">
											...
											<div class="order_cancle_btn_item">
												<a href="javascript:clickpaymentslipmodal('<?php echo  $value->order_unique_id; ?>)">
											<div class="cancle_order_btn"> <?= $this->lang->line('payment_slip') ?></div>
											</a>
										</div>
										<?php }?>
									</div>
...
<div id="paymentSlipModal" class="modal" style="z-index: 9999999;background: rgba(0,0,0,0.8);text-align:center;">
	<div class="modal-dialog modal-paymentslip" style="width: fit-content">
		<div class="modal-content">
			<div class="modal-header">
			
				<h4 class="modal-title" style="margin-top:15px;text-align:center;width: 100%;padding: 0;"><?= $this->lang->line('payment_slip') ?></h4>
			</div>
			<div class="modal-body" style="padding-top: 0px">
				<div class="col-md-12">
							<div class="wizard-form-field">
			...
			<div class="modal-footer" style="text-align: center;">
				...
				<button class="btn btn-default btn_cancel" data-dismiss="modal" aria-label="Close" >Cancel</button>
			</div>
		</div>
	</div>
</div>
...
<script type="text/javascript">
	...
	function clickpaymentslipmodal(order_id){
